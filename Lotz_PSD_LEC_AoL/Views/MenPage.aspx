<%@ Page Title="" Language="C#" MasterPageFile="~/Views/NavBarFooter.Master" AutoEventWireup="true" CodeBehind="MenPage.aspx.cs" Inherits="Lotz_PSD_LEC_AoL.Views.MenPage" %>
        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1">
                        <asp:Label ID="searchCloth" runat="server">Men</asp:Label></h1>
                </div>
            </div>
                <div class="row">
