...
{
    public partial class ShowSearchPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            searchCloth.Text = "Showing Results of `" + getName() + "`";
            BindCardItems();
        }

       private String getName()
       {
          String s = Session["SearchFor"].ToString();
          return s;
       }

        private void BindCardItems()
        {
            List<Cloth> cardItems = ClothController.GetClothByName(getName());
